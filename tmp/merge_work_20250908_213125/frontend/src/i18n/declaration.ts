...
export enum I18nKey {
  ...
  // InsightAI related keys
  INSIGHT_AI$TAB_TERMINAL = "INSIGHT_AI$TAB_TERMINAL",
  INSIGHT_AI$TAB_FILES = "INSIGHT_AI$TAB_FILES",
  INSIGHT_AI$WORKSPACE_TITLE = "INSIGHT_AI$WORKSPACE_TITLE",
  INSIGHT_AI$WORKSPACE_DESCRIPTION = "INSIGHT_AI$WORKSPACE_DESCRIPTION",
  INSIGHT_AI$PROCESSING = "INSIGHT_AI$PROCESSING",
  INSIGHT_AI$PROJECT_FILES = "INSIGHT_AI$PROJECT_FILES",
  INSIGHT_AI$SELECT_FILE_TO_VIEW = "INSIGHT_AI$SELECT_FILE_TO_VIEW",
}
