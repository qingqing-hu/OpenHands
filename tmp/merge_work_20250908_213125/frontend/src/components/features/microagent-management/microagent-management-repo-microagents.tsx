...
<<<<<<< /Users/yddyf/Documents/code/openhands8/OpenHands-main-3/frontend/src/components/features/microagent-management/microagent-management-repo-microagents.tsx
  const { full_name: repositoryName, git_provider: gitProvider } = repository;
||||||| /tmp/source-analysis/OpenHands-main/frontend/src/components/features/microagent-management/microagent-management-repo-microagents.tsx
  const { t } = useTranslation();

  const { full_name: repositoryName } = repository;
=======
  const { full_name: repositoryName } = repository;
>>>>>>> /tmp/colleague-analysis/colleague-code/frontend/src/components/features/microagent-management/microagent-management-repo-microagents.tsx
