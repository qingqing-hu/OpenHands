...
${t.content}
\`\`\``,P=t=>{let{content:e}=t;return`Output:
\`\`\`sh
...
**Output:**
${t.content}`,e.length>h&&(e=`${e.slice(0,h)}...(truncated)`),e},J=t=>{let e="";if(t.extras.recall_type==="workspace_context"){if(t.extras.repo_name&&(e+=`
